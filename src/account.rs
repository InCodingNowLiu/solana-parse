use crate::typedefs::{
    PoolFeesConfig, PoolFeesStruct, PoolMetrics, PositionMetrics, RewardInfo, UserRewardInfo,
};
...
impl ClaimFeeOperatorAccount {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        ...
        Ok(Self(<ClaimFeeOperator as BorshDeserialize>::deserialize(
            &mut reader,
        )?))
    }
...
impl ConfigAccount {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        ...
        Ok(Self(<Config as BorshDeserialize>::deserialize(
            &mut reader,
        )?))
    }
    pub fn serialize<W: std::io::Write>(&self, mut writer: W) -> std::io::Result<()> {
...
impl PositionAccount {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        ...
        Ok(Self(<Position as BorshDeserialize>::deserialize(
            &mut reader,
        )?))
    }
    pub fn serialize<W: std::io::Write>(&self, mut writer: W) -> std::io::Result<()> {
...
impl TokenBadgeAccount {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        ...
        Ok(Self(<TokenBadge as BorshDeserialize>::deserialize(
            &mut reader,
        )?))
    }
    pub fn serialize<W: std::io::Write>(&self, mut writer: W) -> std::io::Result<()> {
...
impl VestingAccount {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        ...
        Ok(Self(<Vesting as BorshDeserialize>::deserialize(
            &mut reader,
        )?))
    }
    pub fn serialize<W: std::io::Write>(&self, mut writer: W) -> std::io::Result<()> {
